<template>
	<view class="container container25494">
		...
		<view class="flex diygw-col-24 flex-nowrap justify-center flex-clz align-center" style="line-height: 40px; margin-left:18px;margin-right: 18px;">
			<view  class=" diygw-col-7">
				作者：{{share.author}}
			</view>
			<view class=" diygw-col-8">
				发布人：{{nickname}}
			</view>
			<view class=" diygw-col-4">
				积分：{{share.price}}
			</view>
			<view  class="diygw-col-6" v-if="share.isOriginal">
				来源：原创
			</view>
			<view  class="diygw-col-6" v-else>
				来源：转载
			</view>
		</view>
		...
		<view class="flex flex-wrap diygw-col-24 flex-direction-column">
			<view class="diygw-col-24 text-clz"> {{share.downloadUrl}} </view>
			<view class="diygw-col-24 text-clz"> {{share.summary}} </view>
		</view>
		<view class="flex diygw-col-24">
			<button @tap="paste" class="diygw-btn grey radius-xs flex-sub margin-xs button-button-clz">复制下载地址</button>
		</view>
...
<script>
import { SHARE_URL } from '../../util/api';
