					...
					<view v-for="(share,index) in shares" :key="index">
						<view class="flex diygw-col-24 flex-nowrap flex-clz">
							...
							<view class="diygw-col-10 flex margin-top-5 justify-center align-center" style="height: 97px; padding: 3px 5px;">
								<image :src="share.cover"  style="border-radius: 50%; height: 65px;width: 65px; z-index: 33;" mode="aspectFill"></image>
							</view>
							...
							<view class="flex flex-wrap diygw-col-7 flex-direction-column">
								...
								<view  @tap="gotoDetail(share.id)" style="line-height: 18px;" class=" diygw-col-21 text3-clz"> 下载 </view>
							</view>
						</view>
					</view>
			</view>
...
<script>
import {LATEST_NOTICE_URL, MY_EXCHANGE_URL, SHARE_LIST_URL} from '../../util/api.js';
