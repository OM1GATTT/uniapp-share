					...
					<view v-for="(share,index) in shares" :key="index">
						<view class="flex diygw-col-24 flex-nowrap flex-clz">
							...
							<view class="flex flex-wrap diygw-col-7 justify-center align-center">
								<view v-if="share.auditStatus === 'PASS'" class="diygw-tag flex-direction-row-reverse margin-xs radius bg-green">
									<text class="diygw-icon diy-icon-pullright"></text>
									<text> 审核通过 </text>
								</view>
								<view v-if="share.auditStatus === 'NOT_YET'" class="diygw-tag flex-direction-row-reverse margin-xs radius blue">
									<text class="diygw-icon diy-icon-pullright"></text>
									<text> 待审核 </text>
								</view>
								<view v-if="share.auditStatus === 'REJECT'" class="diygw-tag flex-direction-row-reverse margin-xs radius red">
									<text class="diygw-icon diy-icon-pullright"></text>
									<text> 未通过 </text>
								</view>
							</view>
...
<script>
import {MY_CONTRIBUTE_URL} from '../../util/api.js';
