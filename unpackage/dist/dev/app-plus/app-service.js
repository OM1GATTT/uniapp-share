...
(function(vue, shared) {
  ...
  const __easycom_0$3 = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["render", _sfc_render$e], ["__file", "D:/uniapp/uniapp-share-app/components/diy-noticebar/diy-noticebar.vue"]]);
  ...
  const _sfc_main$e = {
    ...
    methods: {
      ...
      async getNotice() {
        ...
        formatAppLog("log", "at pages/index/index.vue:182", res2.data);
  ...
  function _sfc_render$d(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_diy_noticebar = resolveEasycom(vue.resolveDynamicComponent("diy-noticebar"), __easycom_0$3);
    return vue.openBlock(), vue.createElementBlock("view", { class: "container container25494" }, [
      vue.createElementVNode("view", { class: "flex diygw-col-24 flex-direction-column tabs-clz" }, [
        ...
        vue.createElementVNode("view", { class: "" }, [
          $data.tabsIndex == 0 ? (vue.openBlock(), vue.createElementBlock("view", {
            ...
            vue.createElementVNode("scroll-view", { class: "itemList-container" }, [
              (vue.openBlock(true), vue.createElementBlock(
                vue.Fragment,
                null,
                vue.renderList($data.shares, (share, index) => {
                  return vue.openBlock(), vue.createElementBlock("view", { key: index }, [
                    vue.createElementVNode("view", { class: "flex diygw-col-24 flex-nowrap flex-clz" }, [
                      vue.createElementVNode("view", { style: { "z-index": "999", "color": "white", "line-height": "100%" } }, [
                        share.isOriginal ? (vue.openBlock(), vue.createElementBlock("text", {
                          key: 0,
                          style: { "position": "absolute", "left": "-15px", "margin-left": "18px", "top": "8px", "background-color": "red", "font-size": "13px", "padding": "2px 5px", "letter-spacing": "2px" }
                        }, "原创")) : (vue.openBlock(), vue.createElementBlock("text", {
                          key: 1,
                          style: { "position": "absolute", "left": "-15px", "margin-left": "18px", "top": "8px", "background-color": "lightgreen", "font-size": "13px", "padding": "2px 5px", "letter-spacing": "2px" }
                        }, "转载"))
                      ]),
                      vue.createElementVNode("view", {
                        class: "diygw-col-10 flex margin-top-5 justify-center align-center",
                        style: { "height": "97px", "padding": "3px 5px" }
                      }, [
                        vue.createElementVNode("image", {
                          src: share.cover,
                          style: { "height": "60px", "width": "60px", "z-index": "33" },
                          mode: "aspectFill"
                        }, null, 8, ["src"])
                      ]),
                      vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 flex-direction-column" }, [
                        ...
                        vue.createElementVNode(
                          "view",
                          {
                            class: "diygw-text-line2 diygw-col-24 text1-clz margin-top-sm",
                      ...
                      vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-7 flex-direction-column" }, [
                        vue.createElementVNode(
                          "view",
                          {
                            class: "diygw-col-21 text2-clz",
                            style: { "margin-top": "32px", "line-height": "18px" }
                          },
                        ...
                        share.downloadUrl ? (vue.openBlock(), vue.createElementBlock("view", {
                          ...
                          class: "diygw-col-21 text3-clz"
                        }, " 下载 ")) : (vue.openBlock(), vue.createElementBlock("view", {
                          key: 1,
                          style: { "line-height": "18px" },
                          class: "diygw-col-21 text3-clz"
                        }, " 兑换 "))
          ...
          $data.tabsIndex == 1 ? (vue.openBlock(), vue.createElementBlock("view", {
            ...
            vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 flex-direction-column flex6-clz" }, [
              vue.createElementVNode("view", { class: "flex diygw-col-24 flex-nowrap flex7-clz" }, [
                vue.createElementVNode("view", { class: "diygw-col-4 text8-clz diygw-text-xs" }, " 01 "),
                vue.createElementVNode("view", { class: "diygw-col-9 text9-clz" }, " 积分获得方式 ")
              ]),
              vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 flex-direction-column flex8-clz" }, [
                vue.createElementVNode("view", { class: "diygw-col-24 text10-clz" }, " 每日签到 "),
                vue.createElementVNode("view", { class: "diygw-col-24 text11-clz" }, " 投稿 ")
              ])
            ]),
            vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 flex-direction-column flex21-clz" }, [
              vue.createElementVNode("view", { class: "flex diygw-col-24 flex-nowrap flex22-clz" }, [
                vue.createElementVNode("view", { class: "diygw-col-4 text28-clz diygw-text-xs" }, " 01 "),
                vue.createElementVNode("view", { class: "diygw-col-9 text29-clz" }, " 深入交流 ")
              ]),
              vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 flex-direction-column flex23-clz" }, [
                vue.createElementVNode("view", { class: "diygw-col-24 text30-clz" }, " 技术交流QQ群：88888888 "),
                vue.createElementVNode("view", { class: "diygw-col-24 text31-clz" }, " 私人微信：OMG1A ")
              ])
            ])
          ])) : vue.createCommentVNode("v-if", true)
        ])
      ]),
      vue.createElementVNode("view", { class: "flex diygw-col-24 diygw-bottom" }, [
        vue.createElementVNode("view", { class: "diygw-grid diygw-actions" }, [
          vue.createElementVNode("button", {
            ...
            vue.createElementVNode("view", { class: "diygw-grid-inner" }, [
              vue.createElementVNode("view", {
                class: "diygw-grid-icon diygw-avatar",
                style: {}
              }, [
                vue.createElementVNode("image", {
                  mode: "aspectFit",
                  class: "diygw-avatar-img",
                  src: "/static/global/shouye_unselect.png"
                })
              ]),
              vue.createElementVNode("view", { class: "diygw-grid-title" }, " 首页 ")
            ])
          ]),
          vue.createElementVNode("button", {
            ...
            vue.createElementVNode("view", { class: "diygw-grid-inner" }, [
              vue.createElementVNode("view", {
                ...
                vue.createElementVNode("image", {
                  mode: "aspectFit",
                  class: "diygw-avatar-img",
                  src: "/static/global/account_detail.png"
                })
              ]),
              vue.createElementVNode("view", { class: "diygw-grid-title" }, " 投稿 ")
            ])
          ]),
          vue.createElementVNode("button", {
            ...
            vue.createElementVNode("view", { class: "diygw-grid-inner" }, [
              vue.createElementVNode("view", {
                ...
                vue.createElementVNode("image", {
                  mode: "aspectFit",
                  class: "diygw-avatar-img",
                  src: "/static/global/wode_unselect.png"
                })
              ]),
              vue.createElementVNode("view", { class: "diygw-grid-title" }, " 我的 ")
            ])
          ])
        ])
      ]),
  ...
  const PagesIndexIndex = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["render", _sfc_render$d], ["__scopeId", "data-v-1cf27b2a"], ["__file", "D:/uniapp/uniapp-share-app/pages/index/index.vue"]]);
  const _sfc_main$d = {
    name: "u-icon",
  ...
  const __easycom_0$2 = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["render", _sfc_render$c], ["__scopeId", "data-v-305117c1"], ["__file", "D:/uniapp/uniapp-share-app/uni_modules/diy-uview-ui/components/u-icon/u-icon.vue"]]);
  const _sfc_main$c = {
    name: "u-radio",
    emits: ["change"],
    props: {
  ...
  const __easycom_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["render", _sfc_render$b], ["__scopeId", "data-v-088e54f1"], ["__file", "D:/uniapp/uniapp-share-app/uni_modules/diy-uview-ui/components/u-radio/u-radio.vue"]]);
  ...
  const __easycom_1$1 = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["render", _sfc_render$a], ["__scopeId", "data-v-abc7d820"], ["__file", "D:/uniapp/uniapp-share-app/uni_modules/diy-uview-ui/components/u-radio-group/u-radio-group.vue"]]);
  function _extends() {
  ...
  const __easycom_1 = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["render", _sfc_render$9], ["__scopeId", "data-v-e2d0cb75"], ["__file", "D:/uniapp/uniapp-share-app/uni_modules/diy-uview-ui/components/u-form-item/u-form-item.vue"]]);
  const _sfc_main$9 = {
    name: "u-input",
  ...
  const __easycom_0 = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["render", _sfc_render$8], ["__scopeId", "data-v-42f09606"], ["__file", "D:/uniapp/uniapp-share-app/uni_modules/diy-uview-ui/components/u-input/u-input.vue"]]);
  const _sfc_main$8 = {
    data() {
      return {
        //用户全局信息
  ...
  function _sfc_render$7(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "container container25494" }, [
      ...
      vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 flex-direction-column flex-clz" }, [
        vue.createElementVNode("view", { class: "flex diygw-col-24 items-center flex-wrap" }, [
          vue.createElementVNode("view", { class: "diygw-col-24 text2-clz" }, " 原创 "),
          vue.createVNode(_component_u_form_item, {
            class: "diygw-col-4 radio-clz diygw-form-item-small",
            labelPosition: "top",
            prop: "radio"
          }, {
            default: vue.withCtx(() => [
          ...
          vue.createElementVNode("view", { class: "diygw-col-24 text3-clz" }, " 转载 ")
        ]),
        vue.createVNode(_component_u_form_item, {
          class: "diygw-col-24 input-clz diygw-form-item-small",
          label: "标题",
          prop: "input"
        }, {
          default: vue.withCtx(() => [
        ...
        vue.createVNode(_component_u_form_item, {
          class: "diygw-col-24 input5-clz diygw-form-item-small",
          label: "作者",
          prop: "input5"
        }, {
          default: vue.withCtx(() => [
            vue.createVNode(_component_u_input, {
              ...
              class: "",
              placeholder: "请输入作者",
              modelValue: $data.input5,
              "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => $data.input5 = $event),
              type: "text"
            }, null, 8, ["focus", "modelValue"])
          ]),
          _: 1
        ...
        vue.createVNode(_component_u_form_item, {
          class: "diygw-col-24 input4-clz diygw-form-item-small",
          label: "价格",
          prop: "input4"
        }, {
          default: vue.withCtx(() => [
            vue.createVNode(_component_u_input, {
              ...
              class: "",
              placeholder: "请输入价格",
              modelValue: $data.input4,
              "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => $data.input4 = $event),
              type: "text"
            }, null, 8, ["focus", "modelValue"])
          ]),
          _: 1
        ...
        vue.createVNode(_component_u_form_item, {
          class: "diygw-col-24 input3-clz diygw-form-item-small",
          label: "简介",
          prop: "input3"
        }, {
          default: vue.withCtx(() => [
            vue.createVNode(_component_u_input, {
              ...
              class: "",
              placeholder: "介绍一下技术干货把",
              modelValue: $data.input3,
              "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => $data.input3 = $event),
              type: "text"
            }, null, 8, ["focus", "modelValue"])
          ]),
          _: 1
        ...
        vue.createVNode(_component_u_form_item, {
          class: "diygw-col-24 input2-clz diygw-form-item-small",
          label: "封面图",
          prop: "input2"
        }, {
          default: vue.withCtx(() => [
            vue.createVNode(_component_u_input, {
              ...
              "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => $data.input2 = $event),
              type: "text"
            }, null, 8, ["focus", "modelValue"])
          ]),
          _: 1
        ...
        vue.createVNode(_component_u_form_item, {
          class: "diygw-col-24 input1-clz diygw-form-item-small",
          label: "下载地址",
          prop: "input1"
        }, {
          default: vue.withCtx(() => [
            vue.createVNode(_component_u_input, {
              ...
              "onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => $data.input1 = $event),
              type: "text"
            }, null, 8, ["focus", "modelValue"])
          ]),
          _: 1
  ...
  const PagesContributeContribute = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["render", _sfc_render$7], ["__scopeId", "data-v-43f66588"], ["__file", "D:/uniapp/uniapp-share-app/pages/contribute/contribute.vue"]]);
  const _sfc_main$7 = {
    data() {
      return {
        //用户全局信息
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "container container25494" }, [
      !$data.userInfo ? (vue.openBlock(), vue.createElementBlock("view", {
        ...
        vue.createElementVNode("view", { class: "flex diygw-col-24 justify-center avatar-clz" }, [
          vue.createElementVNode("view", { class: "diygw-avatar avatar-avatar radius bg-none" }, [
            vue.createElementVNode("image", {
              mode: "aspectFill",
        ...
        vue.createElementVNode("view", {
          class: "diygw-col-24 text-clz margin-bottom-md",
          style: { "line-height": "30px", "font-size": "16px" }
        }, " 登录，享受技术之旅 "),
        vue.createElementVNode("view", { class: "flex diygw-col-24 flex-nowrap" }, [
          vue.createElementVNode("view", { class: "flex diygw-col-24 justify-center" }, [
            vue.createElementVNode("button", {
              onClick: _cache[0] || (_cache[0] = (...args) => _ctx.navigateTo && _ctx.navigateTo(...args)),
              "data-type": "page",
              "data-url": "/pages/login/login",
              class: "diygw-btn red radius-xs button-button-clz"
            }, "登录")
          ])
        ])
      ...
      $data.userInfo ? (vue.openBlock(), vue.createElementBlock("view", {
        ...
        vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 flex-direction-column margin-top-lg" }, [
          vue.createElementVNode("view", {
            onClick: _cache[2] || (_cache[2] = (...args) => _ctx.navigateTo && _ctx.navigateTo(...args)),
            "data-type": "page",
            "data-url": "/pages/myExchange/myExchange",
            class: "diygw-col-24 text2-clz"
          }, " 我的兑换 ")
        ]),
        vue.createElementVNode("view", {
          onClick: _cache[3] || (_cache[3] = (...args) => _ctx.navigateTo && _ctx.navigateTo(...args)),
          "data-type": "page",
          "data-url": "/pages/pointsDetail/pointsDetail",
        ...
        }, " 审核投稿 ")) : vue.createCommentVNode("v-if", true)
      ])) : vue.createCommentVNode("v-if", true),
      vue.createElementVNode("view", { class: "clearfix" })
    ]);
  }
  const PagesMineMine = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$6], ["__scopeId", "data-v-7c2ebfa5"], ["__file", "D:/uniapp/uniapp-share-app/pages/mine/mine.vue"]]);
  const _sfc_main$6 = {
    data() {
      return {
        //用户全局信息
    ...
    methods: {
      ...
      async login() {
        ...
        formatAppLog("log", "at pages/login/login.vue:81", res2);
        if (res2.success === true) {
          uni.showToast({
            title: "登录成功"
          });
          formatAppLog("log", "at pages/login/login.vue:86", JSON.stringify(res2.data.user) + "$$$$$$");
  ...
  function _sfc_render$5(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "container container25494" }, [
      vue.createElementVNode("view", {
        class: "flex flex-wrap diygw-col-24 diygw-col-10 justify-center items-center",
        style: { "height": "290px" }
      }, [
        vue.createElementVNode("view", { class: "diygw-col-12" }, [
          vue.createElementVNode("image", {
            src: "/static/QQtp20231008121354.png",
            class: "response diygw-col-24",
            mode: "widthFix"
          })
        ])
      ]),
      vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 flex-direction-column" }, [
        ...
        vue.createElementVNode("view", { class: "flex diygw-col-24 button-clz" }, [
          vue.createElementVNode("button", {
            ...
            class: "diygw-btn green radius-xs flex-sub margin-xs button-button-clz"
          }, "登录", 8, ["disabled"])
        ])
      ]),
      vue.createElementVNode("view", { class: "clearfix" })
  ...
  const PagesLoginLogin = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$5], ["__scopeId", "data-v-e4e4508d"], ["__file", "D:/uniapp/uniapp-share-app/pages/login/login.vue"]]);
  const _sfc_main$5 = {
    data() {
      return {
        url: ""
  ...
  const PagesWebview = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$4], ["__file", "D:/uniapp/uniapp-share-app/pages/webview.vue"]]);
  const _sfc_main$4 = {
    data() {
      return {
        //用户全局信息
  ...
  function _sfc_render$3(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "container container25494" }, [
        ...
        vue.createVNode(_component_u_form_item, {
          ...
          default: vue.withCtx(() => [
            vue.createVNode(_component_u_input, {
              ...
              placeholder: "",
              modelValue: $data.input1,
              "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => $data.input1 = $event),
              type: "text"
            }, null, 8, ["focus", "modelValue"])
          ]),
          _: 1
        ...
        vue.createVNode(_component_u_form_item, {
          ...
          default: vue.withCtx(() => [
            vue.createVNode(_component_u_input, {
              ...
              placeholder: "",
              modelValue: $data.input2,
              "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => $data.input2 = $event),
              type: "text"
            }, null, 8, ["focus", "modelValue"])
          ]),
          _: 1
        ...
        vue.createVNode(_component_u_form_item, {
          ...
          default: vue.withCtx(() => [
            vue.createVNode(_component_u_input, {
              ...
              placeholder: "",
              modelValue: $data.input3,
              "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => $data.input3 = $event),
              type: "text"
            }, null, 8, ["focus", "modelValue"])
          ]),
          _: 1
      ...
      vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 flex-direction-column" }, [
        vue.createElementVNode("view", { class: "diygw-col-24 text-clz" }, " 学会高效 ")
      ]),
      vue.createElementVNode("view", { class: "flex diygw-col-24 diygw-bottom flex-nowrap" }, [
        vue.createElementVNode("view", { class: "flex diygw-col-19 justify-end items-center flex-nowrap" }, [
          vue.createElementVNode("view", { class: "diygw-col-5" }, " ￥积分:10 ")
        ]),
        vue.createElementVNode("view", { class: "flex diygw-col-5 button-clz" }, [
          vue.createElementVNode("button", {
            onClick: _cache[4] || (_cache[4] = (...args) => _ctx.navigateTo && _ctx.navigateTo(...args)),
            "data-type": "tip",
            "data-tip": "兑换成功",
  ...
  const PagesExchangeExchange = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$3], ["__scopeId", "data-v-ea8424b3"], ["__file", "D:/uniapp/uniapp-share-app/pages/exchange/exchange.vue"]]);
  const _sfc_main$3 = {
    data() {
      return {
        //用户全局信息
    ...
    methods: {
      ...
      async getNotice() {
        let res2 = await request(LATEST_NOTICE_URL, "GET");
        formatAppLog("log", "at pages/myContribute/myContribute.vue:105", res2.data);
        this.notice = res2.data.content;
      },
      async getShares(init) {
        if (init) {
              ...
              return vue.openBlock(), vue.createElementBlock("view", { key: index }, [
                vue.createElementVNode("view", { class: "flex diygw-col-24 flex-nowrap flex-clz" }, [
                  vue.createElementVNode("view", {
                    ...
                    vue.createElementVNode("image", {
                      src: share.cover,
                      style: { "border-radius": "20%", "height": "65px", "width": "65px", "z-index": "33" },
                      mode: "aspectFill"
                    }, null, 8, ["src"])
                  ]),
                  vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 flex-direction-column" }, [
                  ...
                  vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-7 justify-center align-center" }, [
                    vue.createElementVNode("view", { class: "diygw-tag flex-direction-row-reverse margin-xs radius bg-green" }, [
                      vue.createElementVNode("text", { class: "diygw-icon diy-icon-pullright" }),
                      vue.createElementVNode("text", null, " 审核通过 ")
                    ])
                  ])
                ])
              ]);
  ...
  const PagesMyContributeMyContribute = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$2], ["__scopeId", "data-v-029c72cf"], ["__file", "D:/uniapp/uniapp-share-app/pages/myContribute/myContribute.vue"]]);
  const _sfc_main$2 = {
    data() {
      return {
        //用户全局信息
    ...
    methods: {
      ...
      async getNotice() {
        let res2 = await request(LATEST_NOTICE_URL, "GET");
        formatAppLog("log", "at pages/myExchange/myExchange.vue:109", res2.data);
        this.notice = res2.data.content;
      },
      async getShares(init) {
        if (init) {
              ...
              return vue.openBlock(), vue.createElementBlock("view", { key: index }, [
                vue.createElementVNode("view", { class: "flex diygw-col-24 flex-nowrap flex-clz" }, [
                  ...
                  vue.createElementVNode("view", {
                    ...
                    vue.createElementVNode("image", {
                      src: share.cover,
                      style: { "border-radius": "50%", "height": "65px", "width": "65px", "z-index": "33" },
                      mode: "aspectFill"
                    }, null, 8, ["src"])
                  ]),
                  vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 flex-direction-column" }, [
  ...
  const PagesMyExchangeMyExchange = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$1], ["__scopeId", "data-v-1e62b5f4"], ["__file", "D:/uniapp/uniapp-share-app/pages/myExchange/myExchange.vue"]]);
  const _sfc_main$1 = {
    data() {
      return {
        //用户全局信息
  ...
  function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", { class: "container container25494" }, [
      vue.createElementVNode("view", { class: "flex diygw-col-24 items-center flex-nowrap" }, [
        vue.createElementVNode("text", { class: "flex icon diygw-col-0 icon-clz diy-icon-pulldown" }),
        vue.createElementVNode("view", { class: "diygw-col-20 text2-clz" }, " 2023-09-26 15:04:58--兑换-10 "),
        vue.createElementVNode("text", { class: "flex icon1 diygw-col-2 icon1-clz diy-icon-zuihouye" })
      ]),
      vue.createElementVNode("view", { class: "clearfix" })
    ]);
  }
  const PagesPointsDetailPointsDetail = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render], ["__scopeId", "data-v-f3d02fe1"], ["__file", "D:/uniapp/uniapp-share-app/pages/pointsDetail/pointsDetail.vue"]]);
  ...
  __definePage("pages/pointsDetail/pointsDetail", PagesPointsDetailPointsDetail);
  const _sfc_main = {
    globalData: {
      userInfo: null,
      tabBar: [],
  ...
  const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "D:/uniapp/uniapp-share-app/App.vue"]]);
