...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    l: common_vendor.n($props.justifyContent),
    ...
    q: $options.elLabelPosition == "left" ? "row" : "column",
    r: $data.validateState === "error" && $options.showError("message")
  }, $data.validateState === "error" && $options.showError("message") ? {
    s: common_vendor.t($data.validateMessage),
    t: $options.elLabelPosition == "left" ? "calc(" + _ctx.$u.addUnit($options.elLabelWidth) + " + 24rpx)" : "0",
    v: $options.elInputAlign == "right" ? "right" : "left"
  } : {}, {
    w: $options.elBorderBottom ? 1 : "",
    x: $data.validateState === "error" && $options.showError("border-bottom") ? 1 : ""
  });
}
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-e2d0cb75"], ["__file", "D:/uniapp/uniapp-share-app/uni_modules/diy-uview-ui/components/u-form-item/u-form-item.vue"]]);
